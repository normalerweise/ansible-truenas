...
def main():
    module = AnsibleModule(
        ...
        # of them.
        required_if=[("state", "present", ("cmd", "path", "script"), True)],
    ...
    # Look up the script.
    try:
        script_info = mw.call("initshutdownscript.query", [["comment", "=", name]])
        ...
        if state == "present":
            ...
            if len(arg) == 0:
                ...
                if module.check_mode:
                    ...
                    try:
                        err = mw.call(
                            "initshutdownscript.update", script_info["id"], arg
                        )
                    except Exception as e:
                        module.fail_json(
                            msg=f"Error updating script {name} with {arg}: {e}"
                        )
            ...
            if module.check_mode:
                ...
                try:
                    ...
                    # Delete script.
                    #
                    err = mw.call("initshutdownscript.delete", script_info["id"])
                except Exception as e:
